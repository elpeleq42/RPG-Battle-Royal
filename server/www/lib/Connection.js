 ...
 */
Connection.prototype._sendText = function (str, callback) {
 ...
 * @param {Function} [callback] will be executed when the data is finally written out
 */
Connection.prototype._sendBinary = function (data, callback) {
	if (this.readyState === this.OPEN) {
		if (!this.outStream) {
 ...
 * @param {Function} [callback] will be executed when the data is finally written out
 */
Connection.prototype._send = function (data, callback) {
	if (typeof data === 'string') {
		this._sendText(data, callback)
	} else if (Buffer.isBuffer(data)) {
		this._sendBinary(data, callback)
	} else {
 ...
 */
Connection.prototype._sendPing = function (data) {
	if (this.readyState === this.OPEN) {
...
Connection.prototype.send=function(data, callback){
	if (typeof data === 'string') {
		...
		throw new TypeError("You can't send a binary to players")
	} else {
		throw new TypeError('data should be either a string or a Buffer instance')
	}
}
