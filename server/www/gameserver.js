...
var map=servmap	|| "default"			  //
const tickrate=30            			 // Between 0 and 1000
					...
					if(c){
						for(var i=0;i<server.connections.length;i++){
							if(server.connections[i].playerid==(a-1000)){
								var possibleX=[11,21,31,40,48,40,44,58,69,60,52,58,68,12,77,8,8,12,3,21,26,26,37,44,39,37,57]
								var possibleY=[8,6,8,9,15,29,36,43,19,9,59,68,62,65,77,29,36,43,45,45,39,25,45,42,53,63,28]
