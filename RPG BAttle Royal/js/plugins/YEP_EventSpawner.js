...
var lastspawnedabove100=1
var lastspawnedunder100=1
...
Yanfly.Param.EventSpawnerID1 = Number(Yanfly.Parameters['IdStartRange1']);
...
Yanfly.SpawnEventAt = function(mapId, eventId, x, y, preserved, mynameis) {
  Yanfly.SpawnEvent(mapId, eventId, x, y, preserved, mynameis);
};

Yanfly.SpawnEventAt1 = function(mapId, eventId, x, y, preserved, mynameis,direction1) {
  if(!direction1) direction1=""
  Yanfly.SpawnEvent1(mapId, eventId, x, y, preserved, mynameis,direction1);
};
...
Game_Map.prototype.setup = function(mapId) {
  ...
  this.setupSpawnedEvents1(mapId);
...
Game_Map.prototype.setupSpawnedEvents1 = function(mapId) {
  if (mapId !== this.mapId() && $gamePlayer) {
    $gameSystem.removeTemporaryMapSpawnedEvents(this.mapId())
  }
  this._spawnedEvents1 = $gameSystem.getMapSpawnedEventData(mapId);
};
...
Game_Map.prototype.spawnEvent = function(mapId, eventId, x, y, preserved, mynameis) {
  var spawnId = lastspawnedunder100 + Yanfly.Param.EventSpawnerID;
  lastspawnedunder100++
  ...
  spawnedEvent.mynameis = mynameis
...
Game_Map.prototype.spawnEvent1 = function(mapId, eventId, x, y, preserved, mynameis,direction1) {
  if(!direction1)direction1=""
  var spawnId = lastspawnedabove100 + Yanfly.Param.EventSpawnerID1;
  lastspawnedabove100++
  ...
  var spawnedEvent = new Game_Event(mapId, eventId);
  spawnedEvent.mynameis = mynameis;
  spawnedEvent.direction1 = direction1;
  this._events[spawnId] = spawnedEvent;

  this._spawnedEvents1[spawnId - Yanfly.Param.EventSpawnerID1] = spawnedEvent;
  $gameTemp._SpawnData = undefined;
};
