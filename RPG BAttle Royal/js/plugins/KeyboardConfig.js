 ...
 *
 * @param Status Key
 * @desc This is the Status action will appear on a key.
 * @default tab
 *
 * @param OpenChat
 * @desc This is the OpenChat action will appear on a key.
 * @default OpenChat
 *
 * @param SendChat
 * @desc This is the SendChat action will appear on a key.
 * @default SendChat
 *
 * @param weapon
 * @desc This is the weapon action will appear for the config text.
 * @default Weapon
 *
 * @param shield
 * @desc This is the shield action will appear for the config text.
 * @default Shield
 *
 * @param potion
 * @desc This is the potion action will appear for the config text.
 * @default Potion
 *
 * @param drop
 * @desc This is the drop action will appear for the config text.
 * @default drop
 *
 * @param dropshield
 * @desc This is the dropshield action will appear for the config text.
 * @default dropshield
 *
 * @param droppotion
 * @desc This is the droppotion action will appear for the config text.
 * @default droppotion
 *
 * @param OK Text
 ...
 *
 * @param lantern
 * @desc This is the flashlight action will appear on a key.
 * @default lantern
 *
 * @param Up Text
...
Yanfly.Param.KeyConfigstatus = String(Yanfly.Parameters['Status Key']);
Yanfly.Param.KeyConfigWeapon = String(Yanfly.Parameters['weapon']);
Yanfly.Param.KeyConfigShield = String(Yanfly.Parameters['shield']);
Yanfly.Param.KeyConfigPotion = String(Yanfly.Parameters['potion']);
Yanfly.Param.KeyConfigdrop = String(Yanfly.Parameters['drop']);
Yanfly.Param.KeyConfigDropShield = String(Yanfly.Parameters['dropshield']);
Yanfly.Param.KeyConfigDropPotion = String(Yanfly.Parameters['droppotion']);
Yanfly.Param.KeyConfigChat = String(Yanfly.Parameters['OpenChat']);
Yanfly.Param.KeyConfigSendChat = String(Yanfly.Parameters['SendChat']);
...
Yanfly.Param.KeyConfigFlashlightKey = String(Yanfly.Parameters['lantern']);
...
Window_KeyConfig.prototype.actionKey = function(action) {
		...
		case 'ok':
			...
			break;
        case 'tab':
            return Yanfly.Param.KeyConfigstatus;
            break;
        case 'lantern':
            return Yanfly.Param.KeyConfigFlashlightKey;
            break;
		case 'weapon':
			return Yanfly.Param.KeyConfigWeapon;
			break;
		case 'shield':
			return Yanfly.Param.KeyConfigShield;
			break;
		case 'potion':
			return Yanfly.Param.KeyConfigPotion;
			break;
		case 'droppotion':
			return Yanfly.Param.KeyConfigDropPotion;
			break;
		case 'dropshield':
			return Yanfly.Param.KeyConfigDropShield;
			break;
		case 'drop':
			return Yanfly.Param.KeyConfigdrop;
			break;
		case 'chat':
			return Yanfly.Param.KeyConfigChat;
			break;
		case 'chatsend':
			return Yanfly.Param.KeyConfigSendChat;
			break;
		case 'escape':
